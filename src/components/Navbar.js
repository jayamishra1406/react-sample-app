  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <label className="form-check-label" for="flexSwitchCheckDefault">Checked switch checkbox input</label>
        </div> */}
        ...
        <input className="form-check-input" value="green" type="checkbox" onClick={props.togglemode} role="switch" id="flexSwitchCheckDefault1"/>
        <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Green mode</label>
        </div>

        <div className={`form-check mx-2 form-switch text-${props.mode==="light"?"dark":"light"}`}>
        <input className="form-check-input" value="red" type="checkbox" onClick={props.togglemode} role="switch" id="flexSwitchCheckDefault2"/>
